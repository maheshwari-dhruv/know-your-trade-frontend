const LINKS = [
  ...
  {
    title: "Stocks",
    items: ["52W High", "52W Low", "Breakout Stocks"],
  },
  {
    title: "Team",
  ...
  {
    title: "Social",
    items: ["Instagram", "Github", "Twitter"],
  },
];
    ...
    <div className="px-8 pt-8 bg-white rounded-lg">
      <div className="flex justify-between">
        <div className="w-1/3 text-left">
          <a href="/" className="mb-3 font-sans text-2xl font-bold text-black">
            KnowYourTrade
          </a>
          <p className="my-3 font-sans text-base">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate,
            optio. Dolore asperiores sunt amet ullam rem labore cumque delectus
            illo sequi nam laudantium repudiandae, tenetur placeat accusamus
            reiciendis ipsam corporis?
          </p>
          ...
          {/* <div className="flex items-center justify-start gap-5 border border-red-800">
        ...
        <div className="flex justify-end w-2/4 gap-8">
      ...
      <div className="px-8 pt-4 font-bold leading-none text-center text-black text-9xl">
        <span className="">KnowYourTrade</span>
      </div>
    </div>
  );
};
